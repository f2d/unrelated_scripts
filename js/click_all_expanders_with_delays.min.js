...
console.log(pendingIndex+' / '+pendingTotalCount+' = '+e.textContent.replace(/^\s+|\s+$/g,'').replace(/\s+/g,' '));(getClickableChild(e)||e).click();}if(!window.stopOpeningExpanders){if(pendingIndex<pendingTotalCount){++pendingIndex;setTimeout(checkPendingElement,900+Math.random()*900);}else{
